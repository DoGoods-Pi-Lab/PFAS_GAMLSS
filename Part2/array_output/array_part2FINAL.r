##PFAS script analysis parts 2a (final bits)
...
for(i in 1:ncol(expAll)){
  ...
  write.csv(tmpexp, paste0("./BS/all/",names(expAll[i]),"_63_results.csv"))
  ...
  write.csv(tmpSI, paste0("./BS/Sex-InteractionCoef/",names(expAll[i]),"_63_SEXinterxn_results.csv"))
